...
export const soloMetrics: MetricConfig[] = [
	{
		key: "xp",
		title: "Experiência",
		description: "XP ganho em cada caçada",
		aliases: ["Raw XP Gain", "XP Gain", "Raw XP/h", "XP/h"],
		color: "#d9a441",
	},
	{
		key: "loot",
		title: "Loot",
		description: "Valor do loot coletado",
		aliases: ["Loot"],
		color: "#8ba66f",
	},
	{
		key: "supplies",
		title: "Supplies",
		description: "Valor gasto em supplies",
		aliases: ["Supplies"],
		color: "#e0a85d",
	},
	{
		key: "balance",
		title: "Balance",
		description: "Resultado financeiro da caçada",
		aliases: ["Balance"],
		color: "#52745c",
	},
	{
		key: "damage",
		title: "Dano",
		description: "Dano causado durante a caçada",
		aliases: ["Damage", "Damage/h"],
		color: "#e05d5d",
	},
	{
		key: "healing",
		title: "Healing",
		description: "Healing realizado durante a caçada",
		aliases: ["Healing", "Healing/h"],
		color: "#a9c38a",
	},
];
...
export const parseSoloHunts = (history: HuntRecord[]): ParsedSoloHunt[] => {
	return history
		.map((record) => {
			try {
				const validation = validateHuntSoloReport(record.rawText);
		...
		.filter((hunt): hunt is ParsedSoloHunt => hunt !== null)
